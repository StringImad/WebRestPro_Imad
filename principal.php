...
<head>
  ...
  <style>
    /* —— Modal limpio y centrado (muy minimal) —— */
    #modalBackdrop {
      position: fixed;
      inset: 0;
      display: none;
...
<body>
  ...
  <section>
<!-- Reemplaza tu bloque del selector+botones por esto -->
<form id="formCarta" action="carta.php" method="get" target="_blank" style="margin-top:10px;">
  <label for="restSelect"><strong>Selecciona restaurante</strong></label>
  <select id="restSelect" name="id_restaurant"></select>

  <div style="margin-top:10px; display:flex; gap:10px;">
    <button id="addBtn" class="btn primary" type="button">➕ Añadir plato</button>
    <button type="submit" class="btn">📖 Ver carta pública</button>
  </div>
</form>
